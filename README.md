...
발달장애인 지원관리 시스템은 **일반이용자(보호자), 기관담당자, 기관관리자, 시스템관리자**의 역할에 따라 지원대상자 관리, 지원신청서 작성, 담당자 지정, 우선순위 설정, 지원계획 및 지원결과 작성과 승인까지 하나의 흐름으로 관리할 수 있도록 구현한 **역할 기반 업무관리 웹 시스템**입니다.

본 프로젝트는 발달장애인 지원 업무를 보다 체계적이고 효율적으로 관리할 수 있도록 업무 절차를 전산화하고 각 사용자 권한에 맞는 기능을 제공하는 것을 목표로 개발되었습니다.
